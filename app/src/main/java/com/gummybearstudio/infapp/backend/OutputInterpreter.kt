...
object OutputInterpreter {
    fun toDetectedObjects(outputs: Outputs): List<DetectedObject> {
        /*
        0: java.nio.DirectByteBuffer[pos=1600 lim=1600 cap=1600]
        1: java.nio.DirectByteBuffer[pos=400 lim=400 cap=400]
        2: java.nio.DirectByteBuffer[pos=400 lim=400 cap=400]
        3: java.nio.DirectByteBuffer[pos=4 lim=4 cap=4]
         */
